...
--
-- This is a single pending migration rather than a sequence: none of the work
-- it carries has been released, so there is no database between this schema and
-- the previous patch for intermediate steps to serve. While this work remains
-- unreleased, further schema changes edit this patch; once it merges, new
-- numbered patches resume.
--
